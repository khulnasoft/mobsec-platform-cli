...
export const DEFAULT_API_URL = "https://api.khulnasoft.com";
export const DEFAULT_LAB_API_URL = "https://lab-api.khulnasoft.com";
export const DEFAULT_LAB_UI_URL = "https://app.khulnasoft.com";
